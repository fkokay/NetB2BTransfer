...
namespace NetTransferService.Jobs
{
    ...
    public class ProductSyncJob : IJob
    {
        ...
        public ProductSyncJob(IServiceProvider serviceProvider, IConfiguration configuration)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            using (IServiceScope scope = _serviceProvider.CreateScope())
            {
                ...
                logger.LogInformation($"Ürün aktarım görevi başladı : {DateTime.Now}");
                ...
                logger.LogInformation($"Ürün aktarım görevi tamamlandı : {DateTime.Now}");
            }
        }
