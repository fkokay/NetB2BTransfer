...
namespace NetTransferService.Jobs
{
    ...
    public class ShipmentSyncJob : IJob
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly IConfiguration _configuration;
        private readonly NetTransferContext _context;

        public ShipmentSyncJob(IServiceProvider serviceProvider, IConfiguration configuration)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            using (IServiceScope scope = _serviceProvider.CreateScope())
            {
                ...
                logger.LogInformation($"Sevkiyat aktarım görevi başladı : {DateTime.Now}");
                ...
                logger.LogInformation($"Sevkiyat aktarım görevi tamamlandı : {DateTime.Now}");
            }
        }
