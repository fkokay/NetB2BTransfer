...
namespace NetTransferService.Jobs
{
    ...
    public class ProductStockSyncJob : IJob
    {
        ...
        public ProductStockSyncJob(IServiceProvider serviceProvider, IConfiguration configuration)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            using (IServiceScope scope = _serviceProvider.CreateScope())
            {
                ...
                logger.LogInformation($"Ürün stok aktarım görevi başladı : {DateTime.Now}");
                ...
                logger.LogInformation($"Ürün stok aktarım görevi tamamlandı : {DateTime.Now}");
            }
        }
