...
namespace NetTransfer.Logo.Library.Class
{
    ...
    public class QueryParam
    {
        ...
        public QueryParam(string orderbyfieldname, string ascdesc)
        {
            limit = "-1";
            offset = "0";
            firmnr = "001";
        ...
        [DataMember(Name = "transferfiche")]
        public int transferfiche { get; set; }


        [DataMember(Name = "SourceUrn")]
        public string SourceUrn { get; set; }


        [DataMember(Name = "checkgibuser")]
        public string checkgibuser { get; set; }

        [DataMember(Name = "isgibuser")]
        public bool isgibuser { get; set; }

        [DataMember(Name = "HbtFicheNumber")]
        public string HbtFicheNumber { get; set; }

        [DataMember(Name = "DestinationUrn")]
        ...
        public string Path
        {
            ...
            get
            {
                return "/ALLinONERestService/RestService/";
            }
            set { }
        }
