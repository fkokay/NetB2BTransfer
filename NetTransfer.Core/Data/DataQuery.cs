...
namespace NetTransfer.Core.Data
{
    public static class DataQuery
    {
        ...
        {
            using (var connect = new SqlConnection("Data Source=(local);Initial Catalog=FEYZAN2025;Integrated Security=False;Persist Security Info=False;User ID=NETTRANSFER;Password=sapass;Trust Server Certificate=True;"))
            {
