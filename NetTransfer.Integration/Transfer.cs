    ...
    public class Transfer
    {
        ...
        public async Task CariTransfer()
        {
            ...
            if (_erpSetting.Erp == "Logo")
            {
                LogoQueryParam param = new LogoQueryParam
                {
                    ...
                    firmnr = "200",
                    periodnr = "1",
                    filter = _b2bParameter.CustomerFilter!,
                    limit = "-1",
                    offset = "0",
        ...
        public async Task CariBakiyeTransfer()
        {
            ...
            if (_erpSetting.Erp == "Logo")
            {
                ...
                if (_b2bParameter.CustomerLastTransfer != null)
                {
                    param.filter += " AND ((CLCARD.CAPIBLOCK_CREADEDDATE >= '" + _b2bParameter.CustomerLastTransfer.Value.ToString("yyyy-MM-dd HH:mm") + "' AND CLCARD.CAPIBLOCK_MODIFIEDDATE IS NULL) OR (CLCARD.CAPIBLOCK_MODIFIEDDATE >= '" + _b2bParameter.CustomerLastTransfer.Value.ToString("yyyy-MM-dd HH:mm") + "' AND CLCARD.CAPIBLOCK_MODIFIEDDATE IS NOT NULL)) ";
                }
        ...
        public async Task MalzemeTransfer()
        {
            ...
            try
            {
                if (_erpSetting.Erp == "Logo")
                {
                    _logger.LogInformation("Logo malzeme sorgusu başlıyor.");
                    LogoQueryParam param = new LogoQueryParam
                    {
                        DbName = _erpSetting.SqlDatabase!,
                        firmnr = "200",
                        periodnr = "1",
                    ...
                    _logger.LogInformation("Malzeme transferi başladı. Erp malzeme sayısı : {count}", itemList.Count);
                ...
                {
                    _logger.LogInformation("Netsis malzeme sorgusu başlıyor.");
                    ...
                    _logger.LogInformation("Malzeme transferi başladı. Erp malzeme sayısı : {count}", malzemeList.Count);
